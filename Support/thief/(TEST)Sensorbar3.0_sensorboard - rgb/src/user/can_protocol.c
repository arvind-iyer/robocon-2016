...
/**
	* @brief Convert 2 bytes of the Can Message into a u16 value
	* @param CanRxMsg msg: The received can message
	* @retval the coverted u16 value
	*/
u16 Two_Bytes_into_u16(CanRxMsg *msg)
{
	u16 temp;
	temp = (*msg).Data[0];
	temp = temp | (*msg).Data[1] << 8;
	return temp;
}
