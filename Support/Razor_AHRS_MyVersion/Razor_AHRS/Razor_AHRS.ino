...
* 
* Updated in April, 2016 By Rex Cheng
* H K U S T
* ROBOCON 2016
...
#define MAGN_X_MIN ((float) -70)
#define MAGN_X_MAX ((float) 1023)
#define MAGN_Y_MIN ((float) -319)
#define MAGN_Y_MAX ((float) 774)
#define MAGN_Z_MIN ((float) -766)
#define MAGN_Z_MAX ((float) 239)
...
float gyro_dynamic_offset[3] = {0.0f};
