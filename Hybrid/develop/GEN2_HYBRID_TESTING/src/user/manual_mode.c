...
void manual_reset(){
	...
	is_rotating = using_laser_sensor = pole_as_front = facing_pole = brushless_str = false;
...
void manual_interval_update(){
	...
	tft_append_line("%d %d %d %d %d %d", using_laser_sensor, manual_stage, facing_pole, brushless_str);
