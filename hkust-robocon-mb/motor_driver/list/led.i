...
void led_control(LED led, LED_STATE state)
{
	...
	if (led & LED_1) {led_gpio_pin |= ((uint16_t)0x0001);}
	if (led & LED_2) {led_gpio_pin |= ((uint16_t)0x0002);}

	GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), (u16) led_gpio_pin, (BitAction) state);
}
