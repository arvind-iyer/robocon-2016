...
#line 14 "user\\encoder.c"

static s32 adjusted_encoder = 0;		
static s32 rate_change_encoder = 0;	
...
void encoder_init(void)
{
	...
	TIM_EncoderInterfaceConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), TIM_EncoderMode_TI12,						
	...
	TIM_ClearFlag(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), TIM_FLAG_Update);
	TIM_ITConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), TIM_IT_Update, ENABLE);
	
	TIM_SetCounter(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), 32768);
...
void encoder_update(void)
{
	static s32 flowing_flag = 0;						
	static s32 prev_adjusted_encoder = 0;		
	
	s32 source_encoder = TIM_GetCounter(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)));	
	if (source_encoder > 62768) {
		
		TIM_SetCounter(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), source_encoder - 30000);
		++flowing_flag;
	...
	adjusted_encoder = flowing_flag * 30000 + TIM_GetCounter(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))) - 32768;
