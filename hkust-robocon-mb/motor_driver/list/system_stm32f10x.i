...
#line 67 "user\\system_stm32f10x.c"
...
#line 163 "user\\system_stm32f10x.c"
...
#line 190 "user\\system_stm32f10x.c"
...
#line 251 "user\\system_stm32f10x.c"
  ...
  ((SCB_Type *) ((0xE000E000) + 0x0D00))->VTOR = FLASH_BASE | 0x0;  
...
#line 401 "user\\system_stm32f10x.c"
      break;
...
static void SetSysClock(void)
{
#line 433 "user\\system_stm32f10x.c"
  SetSysClockTo72();
...
#line 492 "user\\system_stm32f10x.c"

#line 981 "user\\system_stm32f10x.c"
...
#line 1054 "user\\system_stm32f10x.c"
     
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR &= (uint32_t)((uint32_t)~(((uint32_t)0x00010000) | ((uint32_t)0x00020000) |
                                        ((uint32_t)0x003C0000)));
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | ((uint32_t)0x001C0000));
