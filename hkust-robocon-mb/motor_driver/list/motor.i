...
#line 15 "user\\motor.c"

_Bool FULL_SPEED_LIMIT = 0;		
...
void motor_init(void)
{
  ...
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), &GPIO_InitStructure);
	...
	TIM_OC3PreloadConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), TIM_OCPreload_Enable);
...
void motor_set_pwm(s32 pwm)
{
	...
	TIM_SetCompare3(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), 1799 - Abs(pwm));
