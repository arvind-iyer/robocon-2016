                    ...
                    //Normal working state
                        ...
                        switch(globalState){
                                                ...
                                                if((river || gameZone == LIGHTGREENZONE) && !passedRiver)
                                                    {
                                                        ...
                                                        switch(side){
                                                            case REDSIDE:                                                               
                                                                servo_control(BAJAJ_SERVO, SERVO_MICROS_MID - 140 - (determine_velocity(ENCODER1) * 15));
                                                            break;
                                                            case BLUESIDE:
                                                                servo_control(BAJAJ_SERVO, SERVO_MICROS_MID + 140 + (determine_velocity(ENCODER1) * 15));
                                                            break;                                                            
                            ...
                            case DOWN_SLOPE: //End game, make it turn extreme right / left for the hybrid to grip propeller
                                goNormal();
                                if((get_minimize_count(ENCODER1) > 15) && (gameZone != LIGHTGREENZONE) && (determine_velocity(ENCODER1) < (float)1.0)){
                            ...
                            case FINISH:
                                ...
                                switch(side){
                                    case REDSIDE:
                                        servo_control(BAJAJ_SERVO,2150);
                                    break;
                                    case BLUESIDE:
