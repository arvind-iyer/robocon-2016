...
//			uart_tx(COM1, "%d", xbc_get_joy(XBC_JOY_LX));
//			uart_tx(COM1, "%d", xbc_get_joy(XBC_JOY_LY));
//			uart_tx(COM1, "%d", xbc_get_joy(XBC_JOY_RX));
//			uart_tx(COM1, "%d", xbc_get_joy(XBC_JOY_RY));
//			
//			tft_append_line("%d", can_xbc_get_connection());
