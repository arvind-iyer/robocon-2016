...
uint16_t sensor_GPIO_Pins[2] = {LINE_SENSOR_1_PIN, LINE_SENSOR_2_PIN};
...
void line_sensor_init(void){
	...
	GPIO_InitStructure.GPIO_Pin = LINE_SENSOR_1_PIN | LINE_SENSOR_2_PIN;
	GPIO_Init(LINE_SENSOR_GPIO, &GPIO_InitStructure);
}

/**
* Return the state of the line sensor
* @param sensor: LINE_SENSOR_1 / LINE_SENSOR_2
