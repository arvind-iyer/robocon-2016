...
#define MARIO_START                buzzer_play_song(MARIO_BEGIN, 50, 2)
#define MARIO_SONG                      buzzer_play_song(MARIO, 125, 2)
#define MARIO_SONG2                 buzzer_play_song(MARIO2,125,2)
#define BIRTHDAY_SONG_GO                    buzzer_play_song(BIRTHDAY_SONG, 125, 0)
