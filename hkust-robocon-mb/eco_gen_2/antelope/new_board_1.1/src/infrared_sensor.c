...
uint16_t infrared_gpio_pins[4] = {INFRARED_LEFT_PIN, INFRARED_RIGHT_PIN, INFRARED_UPPER_LEFT_PIN};
...
void infrared_sensor_init(){
	...
	GPIO_InitStructure.GPIO_Pin = INFRARED_LEFT_PIN|INFRARED_UPPER_LEFT_PIN;
	...
	GPIO_InitStructure1.GPIO_Pin = INFRARED_RIGHT_PIN;
