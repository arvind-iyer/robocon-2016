...
void servo_init(void){
	...
	//------------------------------//
	TIM_TimeBaseStructure.TIM_Prescaler = 3;												//clk=72M/(71+1)= Hz, interval=?
	TIM_TimeBaseStructure.TIM_Period = 54000;												//pulse cycle= 20000
	//------------------------------//
	...
	//------------------------------//
	TIM_OCInitStructure.TIM_Pulse = 27;														// this part sets the initial CCR value
	//------------------------------//
