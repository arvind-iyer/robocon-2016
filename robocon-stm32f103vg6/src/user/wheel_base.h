...
#define	WHEEL_BASE_W_VEL_RATIO								500		//	50.0%
...
#define	WHEEL_BASE_BR_ACC											1000		// Back-right wheel
#define	WHEEL_BASE_BL_ACC										  1000		// Back-left wheel
#define	WHEEL_BASE_FR_ACC											1000 		// Front wheel

#define XY_BR_SCALE 100
#define XY_BL_SCALE 100
#define XY_FR_SCALE 100
...
static const MOTOR_ID
	MOTOR_BACK_RIGHT 		= MOTOR1,		//changed from MOTOR1		//MOTOR3 for C
	MOTOR_BACK_LEFT 		= MOTOR2,		//changed from MOTOR2		// MOTOR4 for C
	MOTOR_FRONT 				= MOTOR3;
