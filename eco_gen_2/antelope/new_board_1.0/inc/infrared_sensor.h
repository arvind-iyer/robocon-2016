...
#define INFRARED_SENSOR_GPIO GPIOA
#define INFRARED_SENSOR_GPIO2 GPIOB
#define INFRARED_LEFT_PIN GPIO_Pin_1
#define INFRARED_RIGHT_PIN GPIO_Pin_5
#define INFRARED_UPPER_LEFT_PIN GPIO_Pin_6
#define INFRARED_UPPER_RIGHT_PIN GPIO_Pin_0
