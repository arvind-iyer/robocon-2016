...
void encoder_init(void){
    ...
    TIM_EncoderInterfaceConfig(ENCODER_TIMER1, TIM_EncoderMode_TI12,TIM_ICPolarity_Rising, TIM_ICPolarity_BothEdge);
    TIM_SetCounter(ENCODER_TIMER1, 0);
    TIM_Cmd(ENCODER_TIMER1, ENABLE);	

    // Enable counting for Encoder 2
    TIM_EncoderInterfaceConfig(ENCODER_TIMER2, TIM_EncoderMode_TI12,TIM_ICPolarity_Rising, TIM_ICPolarity_BothEdge);
