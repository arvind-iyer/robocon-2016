...
//				river_stage++;
//				set_target(RIVER_STRAIGHT_YAW + RIVER_STR_SLIGHT_CHANGE);
...
//		case 3:
//			#ifdef BLUE_FIELD
//				if ((get_average_encoder() - encoder_start_reading > ENCODER_AFTER_THIRD_ISLAND) || islands_end_count[SECOND_IR_ID] >= 2){
//			#else
//				if ((get_average_encoder() - encoder_start_reading > ENCODER_AFTER_THIRD_ISLAND) || islands_end_count[SECOND_IR_ID] >= 2){
//			#endif
//				river_stage++;
