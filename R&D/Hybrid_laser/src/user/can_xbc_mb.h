...
typedef enum {
  CAN_XBC_DISCONNECTED = 0,   /*!< XBC Board CAN Disconnected ***/
  CAN_XBC_CAN_CONNECTED = 1,  /*!< XBC Board CAN connected, but the XBC USB on the XBC board disconnected ***/
  CAN_XBC_ALL_CONNECTED = 2   /*!< XBC Board All connected ***/
